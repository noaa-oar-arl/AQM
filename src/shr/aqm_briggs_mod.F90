module aqm_briggs_mod
  ...
  public :: aqm_plume_briggs

contains

  subroutine aqm_plume_briggs(em, ns, stkdm, stkht, stktk, stkve, profile, rc)
    ...
    do r = 1, ny
      ...
      subroutine plumeRiseBriggs( ZF, ZH, TA, QV, UW, VW, PRES, &
...
!     Jul 2022 P. C. Campbell:  Added Briggs subroutine to UFS AQM Component
!-----------------------------------------------------------------------
! Modified from:
...
!            CALL M3MESG( XMSG )
      ...
      end subroutine plumeRiseBriggs

end module aqm_briggs_mod
